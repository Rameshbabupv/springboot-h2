...
public class DepartmentRequest {
    ...
    @Pattern(regexp = "^[a-zA-Z0-9\\s&\\-/]+$", message = "Department name can only contain letters, numbers, spaces, &, -, and /")
    private String name;

    @NotBlank(message = "Department code is required")
    @Size(min = 2, max = 10, message = "Department code must be between 2 and 10 characters")
    @Pattern(regexp = "^[A-Z0-9\\-_]+$", message = "Department code can only contain uppercase letters, numbers, -, and _")
    private String code;
